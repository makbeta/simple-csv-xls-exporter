...
Description: Export your posts to CSV or XLS file, through a simple link/button, from either backend or frontend. Works with custom post types, custom taxonomies and custom fields.
Version: 1.1
*/
