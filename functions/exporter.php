...
function ccsve_export(){
    ...
    $ccsve_export_check2 = isset($_REQUEST['export_csv']) ? $_REQUEST['export_csv'] : '';
    if ($ccsve_export_check == 'yes' || $ccsve_export_check == 'csv' || $ccsve_export_check2 == 'yes') {
        echo ccsve_generate();
        exit;
    }
}
...
function ccsve_generate(){
    ...
    if(empty($post_type_var)) {
        ...
        $ccsve_generate_post_type = 'rate-plan-'.$post_type_var;
    }
    /*echo $ccsve_generate_post_type;
    die;*/
